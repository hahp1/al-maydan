...
const T = {
  ...
  'common.exitConfirm':   { ar: 'هل تريد الخروج من التطبيق؟', en: 'Do you want to exit the app?' },
  ...
  'intro.startGame':       { ar: '🎮 ابدأ اللعبة',  en: '🎮 Start Game' },
  'intro.heartCost':       { ar: 'التكلفة: {n} ❤️', en: 'Cost: {n} ❤️' },
  'intro.randomTitle':     { ar: 'مباراة عشوائية',  en: 'Random Match' },
  'intro.randomDesc':      { ar: 'يبحث التطبيق عن خصم متاح تلقائياً، ثم تتنافسان على فئات عشوائية. نقاطك تُحتسب في الترتيب الأسبوعي.', en: 'The app finds an available opponent automatically, then you compete on random categories. Your score counts toward the weekly ranking.' },
  'intro.soloRankedTitle': { ar: 'فردي مصنّف',       en: 'Ranked Solo' },
  'intro.soloRankedDesc':  { ar: 'العب بمفردك عبر فئات تُختار تلقائياً. أجب بأسرع وأدقّ ما يمكن — نقاطك تُسجّل في ترتيب البطولة.', en: 'Play alone through auto-selected categories. Answer as fast and accurately as you can — your score is recorded in the tournament ranking.' },
  'intro.freeTitle':       { ar: 'لعب حر',           en: 'Free Play' },
  'intro.freeDesc':        { ar: 'اختر فئاتك بحرية وتدرّب بلا ضغط ولا توقيت تنافسي. لا يُحتسب في أي ترتيب — للمتعة والتمرين فقط.', en: 'Pick your categories freely and practice without pressure. Not counted in any ranking — just for fun and training.' },
  'knowledge.teamsTitle':  { ar: 'فريقين',           en: 'Two Teams' },
  'knowledge.rankedTitle': { ar: 'تصنيف',            en: 'Ranked' },
  'knowledge.rankedDesc':  { ar: 'عشوائي · مع صديق · فردي — فئات عشوائية', en: 'Random · With friend · Solo — random categories' },
  'knowledge.friendlyTitle': { ar: 'ودية',           en: 'Friendly' },
  'knowledge.friendlyDesc':  { ar: 'مباراة ودية · لعب حر', en: 'Friendly match · Free play' },
  'knowledge.rankedBadge': { ar: '🏆 بطولة',         en: '🏆 Tournament' },
  'knowledge.friendlyBadge': { ar: 'خيارين',         en: '2 options' },
  ...
  'question.answer':        { ar: 'الإجابة:',           en: 'Answer:' },
  ...
  'solo.questions':      { ar: 'سؤال',                  en: 'questions' },
  'solo.finish':         { ar: 'إنهاء',                 en: 'Finish' },
  'solo.next':           { ar: 'التالي',               en: 'Next' },
  ...
  'tokens.upgradePremium':{ ar: '⭐ اشتراك بريميوم',     en: '⭐ Premium Plans' },
  'tokens.planMonthly':   { ar: 'شهري',                  en: 'Monthly' },
  'tokens.planMonthlyAr': { ar: 'اشتراك لمدة شهر — جدّد يومياً', en: '1-month subscription — renews monthly' },
  'tokens.planSixMonths': { ar: 'نصف سنوي',              en: 'Six Months' },
  'tokens.planSixMonthsAr':{ ar: 'اشتراك لمدة 6 أشهر',  en: '6-month subscription' },
  'tokens.planYearly':    { ar: 'سنوي',                  en: 'Yearly' },
  'tokens.planYearlyAr':  { ar: 'اشتراك سنوي — أفضل قيمة', en: 'Annual subscription — best value' },
  'tokens.month6':        { ar: 'شهر',                   en: 'month' },
  'tokens.months6':       { ar: '6 أشهر',                en: '6 months' },
