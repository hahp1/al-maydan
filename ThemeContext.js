...
export const TRUE_MIST = {
  ...
  textSecondary: 'rgba(80,96,112,0.92)',
  textMuted:     'rgba(96,112,128,0.78)',
  textOnAccent:  '#ffffff',
  accent:        '#8898a8',
...
export const BLUE_MIST = {
  ...
  textSecondary: 'rgba(120,150,220,0.92)',
  textMuted:     'rgba(90,120,200,0.78)',
  textOnAccent:  '#ffffff',
  accent:        '#5878d0',
...
export const GREEN_MIST = {
  ...
  textSecondary: 'rgba(100,185,130,0.92)',
  textMuted:     'rgba(70,148,98,0.78)',
  textOnAccent:  '#ffffff',
  accent:        '#3a9058',
...
export const ORANGE_MIST = {
  ...
  textSecondary: 'rgba(200,140,80,0.92)',
  textMuted:     'rgba(165,108,52,0.78)',
  textOnAccent:  '#ffffff',
  accent:        '#c05814',
...
export const BLACK_MIST = {
  ...
  textSecondary: 'rgba(140,165,185,0.92)',
  textMuted:     'rgba(100,125,145,0.78)',
  textOnAccent:  '#ffffff',
  accent:        '#607080',
